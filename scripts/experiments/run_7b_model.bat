...
powershell -Command "(Get-Content config.yaml) -replace 'base_model_name: \"Qwen/Qwen2.5-14B-Instruct\"', 'base_model_name: \"Qwen/Qwen2.5-7B-Instruct\"' | Set-Content config.yaml"
