...
class ComprehensiveTestRunner:
    ...
    def run_comprehensive_suite(self) -> Dict:
        ...
        successful_categories = sum(1 for result in test_categories.values() if result.get("success", False))
        ...
        comprehensive_results = {
            ...
            "summary": {
                ...
                "pipeline_tests_passed": test_categories["certificate_pipeline"].get("success", False),
                "gpu_tests_passed": test_categories["gpu_accelerated"].get("success", False),
                "integration_tests_passed": test_categories["integration_tests"].get("success", False),
                "performance_tests_passed": test_categories["performance_benchmarks"].get("success", False),
                "robustness_tests_passed": test_categories["robustness_tests"].get("success", False)
            }
        }
        
        return comprehensive_results
    
    def save_comprehensive_results(self, results: Dict, output_path: str = "test_results/comprehensive_test_results.json"):
