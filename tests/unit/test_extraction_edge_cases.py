...
class TestTemplateDetection:
    ...
    def test_subscripted_coefficients(self):
        ...
        for template in templates:
            assert is_template_expression(template), f"Failed to detect subscripted template: {template}"
    ...
    def test_ellipsis_patterns(self):
        ...
        for template in templates:
            assert is_template_expression(template), f"Failed to detect ellipsis template: {template}"
