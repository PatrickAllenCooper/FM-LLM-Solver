...
from utils.numerical_checks import (
    NumericalCheckConfig, ViolationInfo, NumericalCheckResult,
    check_domain_bounds_simplified, check_lie_derivative_simplified,
    check_boundary_conditions_simplified
)
from utils.condition_parser import (
    parse_set_conditions_simplified, parse_single_condition,
    parse_or_condition, validate_condition_structure, clean_condition_string
)
from utils.certificate_extraction import (
    extract_certificate_from_llm_output, clean_and_validate_expression,
    is_template_expression
)
from utils.data_formatting import (
    format_instruction_example, format_prompt_completion_example, format_synthetic_example
)
from utils.experiment_analysis import (
    analyze_certificate_complexity
)
...
class TestDataFormatting:
    ...
    def test_format_synthetic_example(self):
        ...
        formatted_instruction = format_synthetic_example(system_desc_text, certificate_str, "instruction")
        ...
        formatted_prompt = format_synthetic_example(system_desc_text, certificate_str, "prompt_completion")
