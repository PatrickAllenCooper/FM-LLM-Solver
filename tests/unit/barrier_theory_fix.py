...
class BarrierCertificateValidator:
    ...
    def compute_level_sets(self, 
                          ...
                          unsafe_set: List[str],
                          variables: List[str],
                          n_samples: int = 1000) -> BarrierLevel:
        """
    ...
    def validate_barrier_conditions(self,
                                  certificate: str,
                                  system: Dict,
        ...
        return {
            ...
            'conditions': {
                'separation': separation_valid,
                'lie_derivative': lie_valid
            },
    ...
    def _check_lie_derivative_condition(self,
                                       certificate: str,
                                       dynamics: List[str],
                                       variables: List[str],
                                       levels: BarrierLevel,
        ...
        lie_derivative = sum(sp.diff(B, var) * fi 
                           for var, fi in zip(var_symbols, f))
    ...
    def _generate_grid_points(self, bounds: Dict, variables: List[str], 
                             grid_size: int) -> List[Tuple[float, ...]]:
