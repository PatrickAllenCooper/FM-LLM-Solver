...
class TestPerformance:
    ...
    def test_monitoring_metrics_performance(self, performance_config_manager):
        ...
        start_time = time.time()
        for i in range(1000):
            monitoring_manager.record_metric(f"test_metric_{i % 10}", float(i), {"worker": str(i % 5)})
    ...
    def test_system_under_load(self, performance_config_manager):
        ...
        while time.time() - start_time < 10:
            try:
                ...
                monitoring_manager.record_metric("load_test_operations", operations, {"type": "load"})
    ...
    def test_memory_usage(self, performance_config_manager):
        ...
        assert memory_after_clear < memory_increase * 0.5, "Memory not properly reclaimed after cache clear"
