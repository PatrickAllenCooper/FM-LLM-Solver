...
from tests.unit.test_extraction_edge_cases import (
    TestDecimalExtraction, TestTemplateDetection, 
    TestFormatSupport, TestEdgeCases
)
...
class Phase1TestRunner:
    ...
    def run_unit_tests(self) -> Dict[str, any]:
        ...
        try:
            ...
            self.print_status("Theory Compliance", "PASS" if theory_passed else "FAIL",
        ...
        for test_name, test_class in extraction_tests:
            try:
                ...
                self.print_status(test_name, "PASS" if failed == 0 else "FAIL",
    ...
    def run_integration_tests(self) -> Dict[str, any]:
        ...
        try:
            ...
            self.print_status("Validation Pipeline", "PASS" if failed == 0 else "FAIL",
    ...
    def run_ground_truth_tests(self) -> Dict[str, any]:
        ...
        try:
            ...
            self.print_status("Ground Truth Tests", 
            ...
            if self.verbose and (failed > 0 or errors > 0):
                ...
                for r in harness.results:
                    if r.correct == False:
                        print(f"  ✗ {r.test_id}: Expected {r.expected_valid}, "
    ...
    def run_performance_tests(self) -> Dict[str, any]:
        ...
        try:
            ...
            self.print_status("Validation Speed", 
