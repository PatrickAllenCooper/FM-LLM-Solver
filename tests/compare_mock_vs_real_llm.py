...
So: B(x,y) = x² + y² - 1""",
                ...
                "challenges": ["Template with variables", "Two-step process", "Parameter specification"]
            },
            {
...
BARRIER_CERTIFICATE_END""",
    ...
    def test_extraction_robustness(self, outputs: List[Dict], test_type: str) -> Dict:
        ...
        for output_data in outputs:
            ...
            if extracted and not is_template:
                try:
                    cleaned = clean_and_validate_expression(extracted, self.test_system["variables"])
    ...
    def run_comparison(self) -> Dict:
        ...
        mock_results = self.test_extraction_robustness(
            self.get_mock_outputs(), "MOCK"
        )
        ...
        print(f"Performance Gap:       {mock_results['success_rate'] - real_results['success_rate']:.1%}")
