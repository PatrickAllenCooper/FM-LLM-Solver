...
class ModelBenchmarker:
    ...
    async def _run_single_benchmark(
        self, model_id: str, task: BenchmarkTask, model_provider
    ) -> BenchmarkResult:
        ...
        return {
            "summary": {
                ...
                "best_performer": {
                    ...
                    "success_rate": (
                        best_success_rate[1].success_rate if best_success_rate else None
                    ),
                },
                "fastest_model": {
            ...
            "rankings": rankings,
            "detailed_results": {
                model_id: asdict(summary) for model_id, summary in summaries.items()
            },
            "benchmark_date": datetime.now().isoformat(),
        }
