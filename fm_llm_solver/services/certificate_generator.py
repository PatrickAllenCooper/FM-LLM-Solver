...
class CertificateGenerator(Generator):
        ...
        try:
            ...
            try:
                certificate = self.parser.parse_certificate(
                    response, 
                    self.parser.extract_variables(system.dynamics)
                )
            except Exception as e:
    ...
    def _retrieve_context(self, system: SystemDescription) -> List[RAGDocument]:
        ...
        try:
            ...
            documents = [
                ...
                if doc.score >= self.config.rag.min_score
            ]
    ...
    def _estimate_confidence(
        ...
        context: Optional[List[RAGDocument]]
    ) -> float:
    ...
    def is_ready(self) -> bool:
        ...
        try:
            ...
            test_result = self.model_provider.generate_text(
                "Test", max_tokens=1
            )
