...
class AsyncManager:
        ...
        try:
            ...
            try:
                ...
                self._metrics['average_duration'] = (
                    (self._metrics['average_duration'] * (self._metrics['tasks_completed'] - 1) + duration)
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        metrics.update({
            ...
            'thread_pool_threads': len(self.thread_pool._threads) if hasattr(self.thread_pool, '_threads') else 0,
