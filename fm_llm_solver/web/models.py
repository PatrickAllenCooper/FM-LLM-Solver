...
class QueryLog(db.Model):
    ...
    # Relationships
    verification_results = db.relationship('VerificationResult', backref='query', lazy='dynamic', cascade='all, delete-orphan')
...
class Conversation(db.Model):
    ...
    # Relationships
    messages = db.relationship('ConversationMessage', backref='conversation', lazy='dynamic', cascade='all, delete-orphan', order_by='ConversationMessage.timestamp')
    ...
    def add_message(self, role: str, content: str, message_type: str = 'chat') -> 'ConversationMessage':
...
class ConversationMessage(db.Model):
    ...
    message_type = db.Column(db.String(20), default='chat', nullable=False)  # chat, system_description, domain_bounds
